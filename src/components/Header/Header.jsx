...
const Header = () => {
    ...
    const links = <>
        ...
        <li className="hover:border border-green-400"><NavLink to={'/latestbooks'}>Latest Books</NavLink></li>
    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl lg:text-3xl font-bold">Book Store</a>
            </div>
            ...
            <div className="navbar-end gap-3">
                <button className="btn btn-info hover:bg-green-500 text-white">Sign In</button>
                <button className="btn btn-info hover:bg-green-500 text-white">Sign Up</button>
            </div>
        </div>
    );
};
